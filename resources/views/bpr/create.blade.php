...
<div class="flex items-center justify-center min-h-screen">
    <form action="{{ route('bpr-store') }}" method="POST" class="w-full max-w-lg p-6 bg-white rounded shadow-lg">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="systolic" id="systolic" required class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>

        <div class="mb-4">
            <label for="diastolic" class="block text-sm font-medium text-gray-700">Tensión Diastólica</label>
            <input type="number" name="diastolic" id="diastolic" required class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>

        <div class="mb-4">
            <label for="pulse" class="block text-sm font-medium text-gray-700">Pulso</label>
            <input type="number" name="pulse" id="pulse" required class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>
